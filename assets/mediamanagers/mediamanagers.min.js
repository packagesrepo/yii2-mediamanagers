! function(t, e) {
    ...
    return function(t) {
        ...
        (function(t) {
            ...
            function U(t) {
                ...
                if (e) {
                    var n, r, o, i = {};
                    if (Array.isArray(e))
                        for (n = e.length; n--;) "string" == typeof(r = e[n]) && (o = qn(r), i[o] = {
                            type: null
                        });
                    else if (d(e))
                        for (var a in e) r = e[a], o = qn(a), i[o] = d(r) ? r : {
                            type: r
                        };
                    t.props = i
                }
            ...
            function L(t, e, n) {
                ...
                U(e), I(e);
                var o = e.extends;
                if (o && (t = "function" == typeof o ? L(t, o.options, n) : L(t, o, n)), e.mixins)
            ...
            function H(t, e, n) {
                if (Kn.errorHandler) Kn.errorHandler.call(null, t, e, n);
                else {
            ...
            function gt(t, e) {
                ...
                if ((o || p(t)) && Object.isExtensible(t)) {
                    ...
                    if (o)
                        for (n = t.length; n--;) gt(t[n], e);
                    else
                        for (r = Object.keys(t), n = r.length; n--;) gt(t[r[n]], e)
                }
            }
            ...
            function St(t, e) {
                for (var n in e) {
                    var r = e[n];
                    if (Array.isArray(r))
                        for (var o = 0; o < r.length; o++) Et(t, n, r[o]);
                    else Et(t, n, r)
                }
            }
            ...
            function Ft(t, e, n, r, o) {
                ...
                Array.isArray(r) && "function" == typeof r[0] && (n = n || {}, n.scopedSlots = {
                    default: r[0]
                }, r.length = 0), o === Br ? r = J(r) : o === Fr && (r = Y(r));
                var i, a;
                if ("string" == typeof e) {
                    var s;
            ...
            function Qt(t) {
                ...
                if (e)
                    for (var n = Array.isArray(e), r = n ? e : ur ? Reflect.ownKeys(e) : Object.keys(e), o = 0; o < r.length; o++) ! function(o) {
            ...
            function He(t, e) {
                var n, r, o, i = t === uo,
                    a = e === uo,
                    s = Ve(t.data.directives, t.context),
                    c = Ve(e.data.directives, e.context),
                    u = [],
                    l = [];
                ...
                if (l.length && K(e.data.hook || (e.data.hook = {}), "postpatch", function() {
                    ...
                    for (n in s) c[n] || We(s[n], "unbind", t, t, a)
            }
            ...
            function sn(t, e) {
                var n, r = {};
                if (e)
                    for (var o = t; o.componentInstance;) o = o.componentInstance._vnode, o.data && (n = on(o.data)) && f(r, n);
                (n = on(t.data)) && f(r, n);
            ...
            function On(t, e, n) {
                ...
                if (!o || Array.isArray(r)) {
                    for (var i, a, s = 0, c = t.options.length; s < c; s++)
                        if (a = t.options[s], o) i = y(r, An(a)) > -1, a.selected !== i && (a.selected = i);
                        else if (m(An(a), r)) return void(t.selectedIndex !== s && (t.selectedIndex = s));
                    o || (t.selectedIndex = -1)
                }
            }
            ...
            var Rn, Fn, Bn = (o("slot,component", !0), Object.prototype.hasOwnProperty),
                qn = c(function(t) {
                ...
                tr = Qn && window.navigator.userAgent.toLowerCase(),
                er = tr && /msie|trident/.test(tr),
                nr = tr && tr.indexOf("msie 9.0") > 0,
                rr = tr && tr.indexOf("edge/") > 0,
                or = tr && tr.indexOf("android") > 0,
                ir = tr && /iphone|ipad|ipod|ios/.test(tr),
                ar = tr && /chrome\/\d+/.test(tr) && !rr,
                sr = function() {
            ...
            var yr = Object.getOwnPropertyNames(mr),
                gr = {
                    shouldConvert: !0,
                    isSettingProps: !1
                },
            ...
            var Or, $r = function() {
                ...
                Dr = 0,
                Pr = function(t, e, n, r) {
                    this.vm = t, t._watchers.push(this), r ? (this.deep = !!r.deep, this.user = !!r.user, this.lazy = !!r.lazy, this.sync = !!r.sync) : this.deep = this.user = this.lazy = this.sync = !1, this.cb = n, this.id = ++Dr, this.active = !0, this.dirty = this.lazy, this.deps = [], this.newDeps = [], this.depIds = new Fn, this.newDepIds = new Fn, this.expression = "", "function" == typeof e ? this.getter = e : (this.getter = w(e), this.getter || (this.getter = function() {})), this.value = this.lazy ? void 0 : this.get()
                };
            ...
            function(t) {
                t.prototype.$nextTick = function(t) {
                    ...
                    var t = this,
                        ...
                        o = e._parentVnode;
                    if (t._isMounted)
                        for (var i in t.$slots) t.$slots[i] = W(t.$slots[i]);
            ...
            var Wr, Gr, Xr = o("input,textarea,option,select"),
                Kr = function(t, e, n) {
                ...
                Bo = function(t) {
                    ...
                    function u(t, e, n, r) {
                        for (var o, i = t; i.componentInstance;)
                            if (i = i.componentInstance._vnode, Le(o = i.data) && Le(o = o.transition)) {
                    ...
                    function f(t, e, n) {
                        ...
                        else s(t.text) && k.appendChild(t.elm, k.createTextNode(t.text))
                    }
                    ...
                    function m(t) {
                        var e, n, r = t.data;
                        if (Le(r))
                            for (Le(e = r.hook) && Le(e = e.destroy) && e(t), e = 0; e < $.destroy.length; ++e) $.destroy[e](t);
                        if (Le(e = t.children))
                    ...
                    function w(t, e, n) {
                        if (Ne(n) && Le(t.parent)) t.parent.data.pendingInsert = e;
                        else
                        ...
                        if (Ie(t)) c = !0, i(n, u, a, s);
                            ...
                            if (!l && Re(t, n)) b(t, n, u, o);
                                ...
                                if (i(n, u, f._leaveCb ? null : d, k.nextSibling(f)), Le(n.parent)) {
                                    ...
                                    if (p(n))
                                        for (var v = 0; v < $.create.length; ++v) $.create[v](uo, n.parent)
                                }
        ...
        e.default = {
            ...
            created: function() {
                this.$root.id = this.id, this.mediamanagers.onCreated({
                    vc: this
                })
            },
            mounted: function() {
                this.mediamanagers.onMounted({
                    el: this.$el,
                    vc: this
                })
            }
        ...
        e.default = {
            ...
            methods: {
                refresh: function() {
                    var t = this;
                    this.loading = !0, this.error = !1, this.api.get(this.listUrl, {
                        params: {
                            path: this.path
                        }
                    }).then(function(e) {
                        Array.isArray(e.data) && (e.data.sort(function(t, e) {
                            var n = t.type + "/" + t.basename,
                                r = e.type + "/" + e.basename;
                ...
                onMediaClick: function(t) {
                    if ("dir" == t.type) this.mmc.browse(t.path);
                    else {
                        var e = this.mmc;
        ...
        Object.defineProperty(e, "__esModule", {
            ...
            computed: {
                ...
                completed: function() {
                    for (var t = void 0, e = 0; e < this.uploads.length; e++)
                        if (t = this.uploads[e], t.loaded < t.total && !t.error) return !1;
                    return !0
                }
            },
            methods: {
        ...
        e.default = {
            ...
            methods: {
                ...
                buildRequest: function(t) {
                    var e = this,
                        n = new FormData;
                    return n.append("path", this.path), n.append("file", t), this.mediamanagers.api.post(this.uploadUrl, n, {
                    ...
                    value: function(t) {
                        if (this.input)
                            if (t.selected)
                                ...
                                } else this.input.el.value = t.selected.path;
                        else this.input.el.value = "";
    ...
    }, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e) {}, function(t, e, n) {
        n(43);
        ...
        t.exports = {
            render: function() {
                ...
                }, [t.advancedUpload ? [n("div", {
                    staticClass: "upload-drop-zone",
                    class: {
                        "drag-over": t.dragOver
                    }
                }, [n("form", {
                ...
                }, [n("strong", [t._v("Choose files")]), t._v(" "), n("span", [t._v("or drag it here")]), t._v(".")]), t._v(" "), n("input", {
                    ref: "fileInput",
                    attrs: {
                        id: t.fileInputId,
                        type: "file",
                ...
                }, [t._v("Your browser does not support drag & drop file upload.")])]], 2)
            },
            staticRenderFns: []
        }
    }, function(t, e) {
        t.exports = {
            render: function() {
                var t = this,
                    ...
                    n = t._self._c || e;
                return n("div", {
                    staticClass: "details-widget panel-modal"
                }, [n("div", {
                    ...
                    staticClass: "details-widget-content panel-body"
                }, [n("table", {
                    ...
                    class: t.mmc.faIconClass(t.file)
                })])]), t._v(" "), n("th", [t._v("Name")]), t._v(" "), n("td", [t._v(t._s(t.file.basename))])]), t._v(" "), n("tr", [n("th", [t._v("Path")]), t._v(" "), n("td", [t._v(t._s(t.file.path))])]), t._v(" "), t.file.timestamp ? n("tr", [n("th", [t._v("Date")]), t._v(" "), n("td", [t._v(t._s(t.file.timestamp))])]) : t._e(), t._v(" "), t.file.size ? n("tr", [n("th", [t._v("Size")]), t._v(" "), n("td", [t._v(t._s(t.file.size))])]) : t._e()])]), t._v(" "), n("p", {
                    staticClass: "buttons"
                }, [n("button", {
                    ...
                    attrs: {
                        href: t.mmc.downloadLink(t.file),
                        role: "button"
                    }
                }, [n("i", {
        ...
        t.exports = {
            render: function() {
                var t = this,
                    ...
                    n = t._self._c || e;
                return n("div", {
                    staticClass: "medias-widget clearfix"
                }, [t.error ? [n("div", {
                    staticClass: "alert alert-warning animated fadeIn"
                }, [t._v("\n            " + t._s(t.error) + "\n            "), n("p", [n("button", {
                ...
                }), t._v(" Click here to retry")])])])] : [n("div", {
                    staticClass: "medias clearfix"
                }, [t.loading ? [n("div", {
                    ...
                    staticClass: "fa fa-fw fa-spin fa-refresh"
                })])])])] : [t.relPath ? n("div", {
                    staticClass: "file file-no-title animated fadeIn",
                    on: {
                        click: function(e) {
                ...
                })])])]) : t._e(), t._v(" "), t._l(t.files, function(e, r) {
                    return n("media-widget", {
                        key: e,
                        staticClass: "animated fadeIn 1234",
                        attrs: {
                            file: e
                        },
                        nativeOn: {
                    ...
                    staticClass: "fa fa-fw fa-info-circle"
                }), t._v(" Details")])]), t._v(" "), n("li", [n("a", {
                    attrs: {
                        href: t.mmc.downloadLink(t.contextMenuFile)
                    }
                }, [n("i", {
                    staticClass: "fa fa-fw fa-download"
                }), t._v(" Download")])]), t._v(" "), t.mmc.isSelected(t.contextMenuFile) ? n("li", [n("a", {
                    attrs: {
                        href: "#"
                    },
                    on: {
        ...
        t.exports = {
            render: function() {
                var t = this,
                    ...
                    n = t._self._c || e;
                return n("div", {
                    staticClass: "mediamanagers",
                    class: {
                        "mediamanagers-fixed-height": t.options.height
                    },
                ...
                }, [n("notification-widget"), t._v(" "), t.options.showBreadcrumb ? n("ol", {
                    ...
                    staticClass: "mediamanagers-content"
                }, [t.options.api.uploadUrl ? n("upload-widget", {
                    directives: [{
                        name: "show",
                        rawName: "v-show",
                        value: t.showUpload,
                    ...
                    on: {
                        "upload-success": t.onUploadSuccess,
                        "upload-error": t.onUploadError
                    }
        ...
        t.exports = {
            render: function() {
                ...
                return n("div", {
                    staticClass: "file",
                    class: {
                        selected: t.mmc.isSelected(t.file)
                    }
                }, [n("div", {
                    staticClass: "file-preview"
                }, [t.file.thumb ? [n("img", {
                    staticClass: "thumb maginific-popup",
                    attrs: {
                        src: t.file.thumb
                    }
                })] : "dir" == t.file.type ? [n("div", {
                    staticClass: "icon"
                }, [n("i", {
                ...
                }, [n("h3", [t._v(t._s(t.file.basename))])])])
            },
            staticRenderFns: []
        }
    }, function(t, e) {
        t.exports = {
            render: function() {
                var t = this,
                    ...
                    n = t._self._c || e;
                return n("div", {
                    staticClass: "upload-status-widget panel-modal"
                }, [n("div", {
                    staticClass: "panel panel-default"
                }, [n("div", {
                    staticClass: "panel-heading"
                    ...
                    staticClass: "table table-bordered"
                }, [n("tbody", t._l(t.uploads, function(e, r) {
                    return n("tr", [n("th", {
                        domProps: {
                            innerHTML: t._s(t.$options.filters.truncate(e.name))
                        }
                    }), t._v(" "), n("td", [n("div", {
                        key: e,
                        ...
                        class: {
                            "progress-bar-success": e.success, "progress-bar-danger": e.error
                        },
